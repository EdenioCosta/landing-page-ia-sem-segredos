...
const testimonials = [
  {
    ...
    photo: testimonial1,
    text: "O Edânio é muito objetivo e direto ao ponto. Saí da palestra sabendo exatamente o que fazer no meu negócio. Nunca imaginei que a IA pudesse ser tão simples de usar.",
  },
  {
    name: "Rafael Oliveira",
    role: "Dono de loja de roupas",
    photo: testimonial2,
    text: "Foi a palestra mais clara que já assisti sobre inteligência artificial. Sem enrolação, sem termos difíceis. Aprendi mais em duas horas do que em meses tentando sozinho.",
  },
  {
    name: "Juliana Santos",
    role: "Consultora de marketing",
    photo: testimonial3,
    text: "Eu tinha medo de tecnologia, mas o Edânio tornou tudo tão simples que saí da palestra já aplicando no meu dia a dia. Meus resultados mudaram completamente.",
  },
  {
    name: "Marcos Ferreira",
    role: "Dono de restaurante",
    photo: testimonial4,
    text: "Achei que IA era coisa de empresa grande. Depois dessa palestra, ficou claro que qualquer negócio pode usar. Já estou economizando horas por semana no meu restaurante.",
  },
  {
    name: "Patrícia Lima",
    role: "Advogada",
